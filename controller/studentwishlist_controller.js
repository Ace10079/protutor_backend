...
exports.register = async (req,res,next) => {
    try {
        ...
        const succesRes = await studentWishListService.studentwishlist(tutor_id,fname,lname,gender,email,phone,address,state,postcode,password,subject,experience,qualification,bio,verification,teacherimage,credits);
