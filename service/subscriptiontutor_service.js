...
class TutorPlanServices{
    static async registerTutorPlan(email,tutor_id,fname,plan_name,plancost,status,tnx_id,date,count,address,phone){
        try{
            var sub_id = await IdcodeServices.generateCode("TutorPlan");
            const createUser = new TutorPlanModel({sub_id,email,tutor_id,fname,plan_name,plancost,status,tnx_id,date,count,address,phone});
    ...
    static async updateTutorPlan(sub_id,tutor_id,fname,plan_name,plancost,status,tnx_id,date,count,address,phone){
        try {
            var query = {sub_id :sub_id};
            var values = {$set : {tutor_id : tutor_id,fname : fname,plan_name : plan_name,plancost : plancost,status : status,tnx_id : tnx_id,date : date,count:count,address:address,phone:phone}};
